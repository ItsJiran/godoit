    ...
    <div class="dashboard-container">
        ...
        <nav class="sidebar" id="sidebar">
            ...
            <div class="menu">
                ...
                <a href="/demo/checkout" class="menu-item">                                        
                    ...
                    <span class="menu-text">Demo Checkout</span>
                </a>

                <a href="/admin/schedule" class="menu-item">
                ...
                <!--<a href="/admin/landing-widget" class="menu-item">
                    <div class="menu-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M480 160L352 160L352 288L480 288L480 160zM544 288L544 480C544 515.3 515.3 544 480 544L160 544C124.7 544 96 515.3 96 480L96 160C96 124.7 124.7 96 160 96L480 96C515.3 96 544 124.7 544 160L544 288zM160 352L160 480L288 480L288 352L160 352zM288 288L288 160L160 160L160 288L288 288zM352 352L352 480L480 480L480 352L352 352z"/></svg></div>
                    <span class="menu-text">Landing Widget</span>
                </a>-->
